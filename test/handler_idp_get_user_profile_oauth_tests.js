...
var handler = require('../idam-api/functions/function_idp_get_user_profile_oauth/handler_idp_get_user_profile_oauth').idp_get_user_profile_oauth;
var mockContext = require('mock-lambda-context');
var mockedEnv = require('mocked-env');
var Mitm = require("mitm");
var Https = require("https");

describe('GET Valid IDP User Profile using OAuth And Convert To Legacy Profile For Migration', function (done) {
    let ctx;
    let event;
    ...
    before(() => {
        ...
        restore = mockedEnv({
            ...
            IDENTITY_PROVIDER_API_GET_USER_ENDPOINT: '/api/v1/user',
        });
    ...
    it('Should retry 3 times on 5xx HTTP Errors when retrieving user info', (done) => {
        mitm.on("request", function (req, res) {
            ...
            else if (req.url.toString().indexOf('user')) {
                res.statusCode = 500
